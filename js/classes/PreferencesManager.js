class PreferencesManager {
	...
	renderPreferences(preferences) {
		...
		if (document.getElementById("orbiteRegionSelect")) {
			document.getElementById("orbiteRegionSelect").value = preferences.region;
		}

		if (document.getElementById("orbiteModePreset")) {
			let modes = [...preferences.modes].sort().join(",");
			let preset = "competitive";
			if (modes === ["team"].sort().join(",")) preset = "team";
			if (modes === ["survival"].sort().join(",")) preset = "survival";
			if (modes === ["team", "survival", "deathmatch", "modding", "custom", "invasion"].sort().join(",")) preset = "all";
			document.getElementById("orbiteModePreset").value = preset;
		}
