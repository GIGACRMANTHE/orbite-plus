...
window.orbiteLeaderboardManager = new OrbiteLeaderboardManager();
window.orbiteLeaderboardManager.initialize();

let refreshList = function() {
    systemListManager._tick();
    window.orbiteLeaderboardManager.collectFromProvider(systemListProvider);
